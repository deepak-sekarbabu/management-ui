...
import { Box, Card, Button, TextField, CardContent } from '@mui/material';
    ...
    const [doctorAbsence, setDoctorAbsence] = useState([
        {
            ...
            absenceDate: "08-05-2024",
            absenceStartTime: "19:00:00",
            absenceEndTime: "20:00:00",
            optionalMessage: "Personal Emergency"
        }
    ]);
